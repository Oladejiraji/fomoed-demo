        ...
        >
          <div className="flex items-center justify-between">
            ...
            <p
              ...
              className="font-medium text-[13px] leading-[1.23] tracking-[-0.01em] text-[#f9f9f9]"
            >
              Deposit
            </p>
            <button
              type="button"
              onClick={handleClose}
              className="w-6 h-6 rounded-full flex justify-center items-center bg-[#171719] cursor-pointer transition-transform duration-160 ease-out active:scale-[0.97]"
            >
              <CloseIcon />
            </button>
          </div>
          ...
          <div className="flex gap-4 flex-col">
            <div className="flex gap-2 flex-col">
              <div className="flex flex-col gap-1">
                <p
                  style={{ fontFamily: "var(--second-family)" }}
                  className="py-1 pl-0.5 text-[12px] font-medium text-[rgba(249,249,249,0.3)] tracking-[0em] leading-none"
                >
                  Select Token
                </p>
                <button
                  ...
                  <div className="h-6 w-6 flex justify-center items-center relative">
                    <div
                      ...
                      style={{
                        ...
                        transition:
                          "transform 160ms ease-out, opacity 160ms ease-out, filter 160ms ease-out",
                      }}
                    >
                      <Copy />
                    </div>
